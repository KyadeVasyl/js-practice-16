...
function compareArrays(arr1, arr2) {
  ...
  console.assert(JSON.stringify(sortedArr1) === JSON.stringify(sortedArr2), "Масиви неоднакові!");
...
function validateUserInput(userInput) {
  ...
  console.assert(userInput.password && userInput.password.length >= 8,
    "Пароль має бути присутнім та бути довшим за 8 символів!")
}
...
function countVowelsAndConsonants(word) {
  ...
  for (let letter of word) {
    ...
    if (vowels.includes(smallLetter)) {
      vowelsCount++;
    } else if (smallLetter >= "a" && smallLetter <= 'z') {
      consonantsCount++;
    }
  }
  ...
  // Скидаємо лічильники
  console.log(`Кількість голосних літер: ${vowelsCount}`);
  console.log(`Кількість приголосних літер: ${consonantsCount}`);
}
